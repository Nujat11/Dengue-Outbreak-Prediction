...
bars = ax2.bar(range(len(monthly_avg)), monthly_avg.values, color=colors, edgecolor='black', linewidth=1.2)
ax2.set_xticks(range(len(monthly_avg)))
ax2.set_xticklabels([pd.Timestamp(year=2020, month=m, day=1).strftime('%b') for m in monthly_order])
ax2.set_xlabel('Month', fontsize=11, fontweight='bold')
ax2.set_ylabel('Average Cases', fontsize=11, fontweight='bold')
ax2.set_title('Average Dengue Cases by Month', fontsize=12, fontweight='bold')
...
bp = ax1.boxplot(seasonal_data, patch_artist=True)
